...
// Source: github.com/goguardian/blox/cluster-state-service/handler/store (interfaces: DataStore)
...
import (
	...
	types "github.com/goguardian/blox/cluster-state-service/handler/store/types"
