...
type ContainerInstanceDetail struct {
	...
	// attributes
	Attributes ContainerInstanceDetailAttributes `json:"attributes"`
	...
	// Required: true
	RegisteredResources ContainerInstanceDetailRegisteredResources `json:"registeredResources"`

	// remaining resources
	// Required: true
	RemainingResources ContainerInstanceDetailRemainingResources `json:"remainingResources"`
...
func (m *ContainerInstanceDetail) validateRegisteredResources(formats strfmt.Registry) error {
	...
	if err := m.RegisteredResources.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("registeredResources")
		}
		return err
	}
...
func (m *ContainerInstanceDetail) validateRemainingResources(formats strfmt.Registry) error {
	...
	if err := m.RemainingResources.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			return ve.ValidateName("remainingResources")
		}
		return err
	}
